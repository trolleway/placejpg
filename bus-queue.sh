...
python3 vehicle-upload.py -v trolleybus --system $SYSTEM  --model Q1628197   i/_trolleybuses/$city/mtb82  --number BEFORE_UNDERSCORE --country countries.gpkg  --progress --street trolleybus.gpkg 
python3 vehicle-upload.py -v trolleybus --system $SYSTEM  --model Q2095280   i/_trolleybuses/$city/ziu5  --number BEFORE_UNDERSCORE --country countries.gpkg  --progress --street trolleybus.gpkg 
...
python3 vehicle-upload.py -v bus --system $mosbus  --model $MAZ105   i/_buses/moscow/mgt_maz105 --country countries.gpkg --number BEFORE_UNDERSCORE --operator-vehicle-category "Mosgortrans buses"  --progress --street trolleybus.gpkg 
...
python3 vehicle-upload.py -v bus --system $mosbus  --model $liaz4292   i/_buses/moscow/tmp20_liaz4292 --country countries.gpkg --number BEFORE_UNDERSCORE  --operator-vehicle-category "TMP20 buses"  --progress --street trolleybus.gpkg 
python3 vehicle-upload.py -v bus --system $mosbus  --model $FordTransit2013   i/_buses/moscow/tmp20_FordTransit2013 --country countries.gpkg --number BEFORE_UNDERSCORE  --operator-vehicle-category "TMP20 buses"  --progress --street trolleybus.gpkg 
python3 vehicle-upload.py -v bus --system $mosbus  --model $liaz5292   i/_buses/moscow/avtoline_liaz5292 --country countries.gpkg --number BEFORE_UNDERSCORE  --operator-vehicle-category "Avtoline buses"  --progress --street trolleybus.gpkg 
